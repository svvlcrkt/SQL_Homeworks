...
```sql
insert into employee (id, name, birthday, email) values (1, 'Elnore', '2019-10-04', 'echance0@sohu.com');
insert into employee (id, name, birthday, email) values (2, 'Tova', '2020-02-08', 'tbarcke1@unc.edu');
insert into employee (id, name, birthday, email) values (3, 'Redd', '2020-02-05', 'rdockrill2@nsw.gov.au');
insert into employee (id, name, birthday, email) values (4, 'Jaclin', '2019-06-03', 'jlodden3@angelfire.com');
insert into employee (id, name, birthday, email) values (5, 'Adelina', '2019-06-14', 'apennoni4@typepad.com');
insert into employee (id, name, birthday, email) values (6, 'Horatia', '2019-06-26', 'hsilbersak5@constantcontact.com');
insert into employee (id, name, birthday, email) values (7, 'Hilliard', '2019-09-24', 'hluquet6@fastcompany.com');
insert into employee (id, name, birthday, email) values (8, 'Ursala', '2019-11-16', 'usnaddon7@home.pl');
insert into employee (id, name, birthday, email) values (9, 'Liesa', '2019-07-18', 'ljefferson8@over-blog.com');
insert into employee (id, name, birthday, email) values (10, 'Herrick', '2019-05-24', 'hsherlock9@epa.gov');
insert into employee (id, name, birthday, email) values (11, 'Zackariah', null, 'zeallisa@independent.co.uk');
insert into employee (id, name, birthday, email) values (12, 'Celinda', '2019-08-18', null);
insert into employee (id, name, birthday, email) values (13, 'Aleta', '2019-10-18', 'acrollc@weather.com');
insert into employee (id, name, birthday, email) values (14, 'Chryste', null, 'ctinklind@vistaprint.com');
insert into employee (id, name, birthday, email) values (15, 'Vanna', null, 'vpantone@forbes.com');
insert into employee (id, name, birthday, email) values (16, 'Howard', '2019-08-25', 'hpodsf@wp.com');
insert into employee (id, name, birthday, email) values (17, 'Brigit', '2019-10-05', 'bdaughtong@disqus.com');
insert into employee (id, name, birthday, email) values (18, 'Margette', '2019-11-13', null);
insert into employee (id, name, birthday, email) values (19, 'Lenore', '2019-08-06', 'lsowrahi@upenn.edu');
insert into employee (id, name, birthday, email) values (20, 'Jodie', null, 'jkeastj@blogger.com');
insert into employee (id, name, birthday, email) values (21, 'Delainey', '2020-01-13', 'dgreberk@over-blog.com');
insert into employee (id, name, birthday, email) values (22, 'Gayleen', null, 'gbarhimsl@deliciousdays.com');
insert into employee (id, name, birthday, email) values (23, 'Judi', '2020-02-03', 'jheapem@intel.com');
insert into employee (id, name, birthday, email) values (24, 'Ailina', null, 'amaccaghann@hhs.gov');
insert into employee (id, name, birthday, email) values (25, 'Olivie', '2019-08-17', 'owilneo@seesaa.net');
insert into employee (id, name, birthday, email) values (26, 'Keane', '2019-07-30', null);
insert into employee (id, name, birthday, email) values (27, 'Leighton', null, 'lmucklestonq@bizjournals.com');
insert into employee (id, name, birthday, email) values (28, 'Madelaine', null, 'mkincaidr@who.int');
insert into employee (id, name, birthday, email) values (29, 'Wilek', '2019-10-13', 'witzkowiczs@uiuc.edu');
insert into employee (id, name, birthday, email) values (30, 'Gar', '2019-12-29', 'ggatlandt@house.gov');
insert into employee (id, name, birthday, email) values (31, 'Imojean', null, 'ibutleru@cornell.edu');
insert into employee (id, name, birthday, email) values (32, 'Gwenni', '2019-08-19', null);
insert into employee (id, name, birthday, email) values (33, 'Lorenza', '2020-02-03', 'lcaudrayw@boston.com');
insert into employee (id, name, birthday, email) values (34, 'Bill', '2020-01-24', 'bbrockhurstx@behance.net');
insert into employee (id, name, birthday, email) values (35, 'De witt', null, 'drowlingsy@youtube.com');
insert into employee (id, name, birthday, email) values (36, 'Del', null, 'dhansiez@creativecommons.org');
insert into employee (id, name, birthday, email) values (37, 'Zarah', '2020-02-16', 'zkirwin10@issuu.com');
insert into employee (id, name, birthday, email) values (38, 'Julita', null, null);
insert into employee (id, name, birthday, email) values (39, 'Rodrigo', '2019-03-29', 'rphetteplace12@e-recht24.de');
insert into employee (id, name, birthday, email) values (40, 'Janot', null, 'jmarklew13@earthlink.net');
insert into employee (id, name, birthday, email) values (41, 'Minda', '2019-06-29', 'mtorrance14@simplemachines.org');
insert into employee (id, name, birthday, email) values (42, 'Quentin', null, 'qkirckman15@123-reg.co.uk');
insert into employee (id, name, birthday, email) values (43, 'Wait', null, 'wvasnev16@java.com');
insert into employee (id, name, birthday, email) values (44, 'Dave', '2019-12-13', null);
insert into employee (id, name, birthday, email) values (45, 'Tonya', '2019-05-15', 'tdiprose18@hao123.com');
insert into employee (id, name, birthday, email) values (46, 'Franz', '2019-06-15', 'fwalklot19@linkedin.com');
insert into employee (id, name, birthday, email) values (47, 'Bess', '2019-08-11', 'bchinnick1a@google.it');
insert into employee (id, name, birthday, email) values (48, 'Olivia', '2019-04-04', 'ojovovic1b@businesswire.com');
insert into employee (id, name, birthday, email) values (49, 'Devan', '2019-09-10', 'dvsanelli1c@craigslist.org');
insert into employee (id, name, birthday, email) values (50, 'Sayer', null, 'sleil1d@trellian.com');
```
